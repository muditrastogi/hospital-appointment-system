...
<?php 
	...
	$sql_app = " SELECT * from appointments WHERE app_id='$app_id' ";
...
<?php 
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") 
	{
		...
		if( empty($nameErr) && empty($ageErr) && empty($genderErr) && empty($dateErr) && empty($timeErr) )
		{
			$u_id=$_SESSION['id'];
			$conn = new mysqli("localhost", "root" , "", "has");
			$sql = "UPDATE appointments SET patient_name='$name',patient_age='$age',gender='$gender',date='$date',time_slot='$time',slot_no='$slot_no'
					WHERE app_id='$app_id' ";	
			if(($conn->query($sql)))
			{
				...
				<div class="form_box">
					<form class="form-horizontal" role="form" action="" method="post">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" name="patient_name" value="<?php echo $row_app['patient_name'];?>"  placeholder="Enter Patient Name">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" name="patient_age" value="<?php echo $row_app['patient_age'];?>" placeholder="Enter Age of Patient">
						...
						<div class="form-group">
							...
							<div class="col-sm-8"> 
								<select name="gender" class="form-control" >
									<option value="<?php echo $row_app['gender'];?>"><?php echo $row_app['gender'];?></option>
